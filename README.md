...
![image](https://github.com/user-attachments/assets/da5cb62b-7525-41cf-b438-691cf0204a19)
![image](https://github.com/user-attachments/assets/4008a6fc-9290-4982-9a8f-ce45eac95293)
![image](https://github.com/user-attachments/assets/87ce9f89-4d5c-4151-b2ee-26fd1079425f)
![image](https://github.com/user-attachments/assets/9153d54f-06cd-436b-a7aa-2f41704cc408)
![image](https://github.com/user-attachments/assets/0c9e5e36-0676-4941-8f03-f3ae12e9ebd2)
1x1 卷积核功能虽然简单，但作用广泛，主要包括：通道维度的降维与扩展（控制计算量）。整合通道间信息（提升特征融合能力）。增强模型的非线性能力。降低计算复杂度（在轻量化网络中尤为重要）
...
### 10. CNN的参数量及浮点数量计算
![image](https://github.com/user-attachments/assets/07c2fc4c-ffeb-4c3f-91f4-af6b62523bd9)
![image](https://github.com/user-attachments/assets/24e992cc-1da9-41a0-9b2a-3c65eb47afd2)
![image](https://github.com/user-attachments/assets/467aa590-b22b-4555-81db-746b1ca60c61)
...
- **《Classifier-Free Diffusion Guidance》**：CFDG 的核心思想是：在同一个扩散模型中同时学习条件生成和无条件生成的能力，并在生成过程中通过两者的加权组合实现条件控制。
![image](https://github.com/user-attachments/assets/fd313266-b426-42ed-8e48-4db935ba0c2c)

- **《High-Resolution Image Synthesis with Latent Diffusion Models》**：Stable Diffusion 是一种基于潜空间扩散模型（Latent Diffusion Models, LDM）的高效生成模型，能够在潜空间中进行扩散过程，从而显著降低计算成本；条件机制通过 Cross-Attention 和条件嵌入的结合，将外部条件（如文本描述）与潜空间特征进行交互，指导扩散过程生成符合条件的图像
...
![image](https://github.com/user-attachments/assets/230e812e-ff3b-4dc3-b0b4-a4354db2b694)
